...
public class DaihatsuRocky extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daihatsu_rocky);
...
//        isiData();
    ...
    public void load(){
        recyclerView = findViewById(R.id.rcvDetailRocky);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
    }

//    public void isiData(){
//        detailMobilList = new ArrayList<DetailMobil>();
//        detailMobilList.add(new DetailMobil("Rocky", "Rocky", "250000", R.drawable.avanza));
//
