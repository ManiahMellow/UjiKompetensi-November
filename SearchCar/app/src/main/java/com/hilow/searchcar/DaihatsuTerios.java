...
public class DaihatsuTerios extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daihatsu_terios);
...
//        isiData();
    ...
    public void load(){
        recyclerView = findViewById(R.id.rcvDetailTerios);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
    }

//    public void isiData(){
//        detailMobilList = new ArrayList<DetailMobil>();
//        detailMobilList.add(new DetailMobil("Terios", "Terios", "250000", R.drawable.avanza));
//
