...
public class ToyotaKijangInnova extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_toyota_kijang_innova);
...
//        isiData();
    ...
    public void load(){
        recyclerView = findViewById(R.id.rcvDetailKijangInnova);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
    }

//    public void isiData(){
//        detailMobilList = new ArrayList<DetailMobil>();
//        detailMobilList.add(new DetailMobil("Kijang Innova", "Kijang", "250000", R.drawable.avanza));
//
