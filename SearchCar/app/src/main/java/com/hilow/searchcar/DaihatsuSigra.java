...
public class DaihatsuSigra extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daihatsu_sigra);
...
//        isiData();
    ...
    public void load(){
        recyclerView = findViewById(R.id.rcvDetailSigra);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
    }

//    public void isiData(){
//        detailMobilList = new ArrayList<DetailMobil>();
//        detailMobilList.add(new DetailMobil("Sigra", "Sigra", "250000",R.drawable.avanza));
//
