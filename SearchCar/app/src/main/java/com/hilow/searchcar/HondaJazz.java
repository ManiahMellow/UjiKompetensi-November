...
public class HondaJazz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_honda_jazz);
...
//        isiData();
    ...
    public void load(){
        recyclerView = findViewById(R.id.rcvDetailJazz);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
    }

//    public void isiData(){
//        detailMobilList = new ArrayList<DetailMobil>();
//        detailMobilList.add(new DetailMobil("Jazz", "Jazz", "250000", R.drawable.avanza));
//
