...
public class HondaHrV extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_honda_hr_v);
...
//        isiData();
    ...
    public void load(){
        recyclerView = findViewById(R.id.rcvDetailHrV);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
    }

//    public void isiData(){
//        detailMobilList = new ArrayList<DetailMobil>();
//        detailMobilList.add(new DetailMobil("HR-V", "HR-V", "250000", R.drawable.avanza));
//
