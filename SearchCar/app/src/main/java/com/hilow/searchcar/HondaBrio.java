...
public class HondaBrio extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_honda_brio);
...
//        isiData();
    ...
    public void load(){
        recyclerView = findViewById(R.id.rcvDetailBrio);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
    }

//    public void isiData(){
//        detailMobilList = new ArrayList<DetailMobil>();
//        detailMobilList.add(new DetailMobil("Brio", "Brio","Brio", R.drawable.avanza));
//
