...
public class ToyotaAvanza extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_toyota_avanza);
...
//        isiData();
    ...
    public void load(){
        recyclerView = findViewById(R.id.rcvDetailAvanza);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
    }

//    public void isiData(){
//        detailMobilList = new ArrayList<DetailMobil>();
//        detailMobilList.add(new DetailMobil("Avanza", "Avanza", "250000", R.drawable.avanza));
//
